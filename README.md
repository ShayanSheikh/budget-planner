This is a simple Savings planner, using Material UI for styling and Google login for auth.

It was bootstrapped using Create React App and is deployed on github pages.
